...
from utils import synthetic_to_refer_paths, synthetic_to_ground_truth_paths
import glob
...
def image_from_paths(fake_image_path, config, is_grayscale=False):
  ...
  filename_queue = tf.train.string_input_producer(fake_image_path_list, shuffle=False, seed=seed)
  mask_queue = tf.train.string_input_producer(fake_ground_truth_paths, shuffle=False, seed=seed)
  filename_refer_queue = tf.train.string_input_producer(refer_image_path, shuffle=False, seed=seed)
