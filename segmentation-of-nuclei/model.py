...
class Model(object):
  ...
  def _build_refiner(self, synthesized, rlyer):
    with tf.variable_scope("refiner") as sc:
      layer = conv2d(synthesized, 32, 3, 1, padding='SAME', normalizer_fn=None, scope="pre_conv_0");

      if self.config.with_ref:
        rlyer = conv2d(rlyer, 32, 4, 1, padding='VALID', normalizer_fn=None, scope="ref_conv_0");
        rlyer = slim.avg_pool2d(rlyer, 3, 2, scope="ref_pool_0")
        rlyer = conv2d(rlyer, 32, 5, 1, padding='VALID', normalizer_fn=None, scope="ref_conv_1");
        rlyer = conv2d(rlyer, 32, 5, 1, padding='VALID', normalizer_fn=None, scope="ref_conv_2");
        rlyer = conv2d(rlyer, 32, 5, 1, padding='VALID', normalizer_fn=None, scope="ref_conv_3");
        rlyer = conv2d(rlyer, 32, 5, 1, padding='VALID', normalizer_fn=None, scope="ref_conv_4");
  ...
  def _build_discrim(self, layer, rlyer, name, reuse=False):
    with tf.variable_scope("discriminator", reuse=reuse) as sc:
      layer = conv2d(layer, 32, 3, 1, padding='VALID', normalizer_fn=None, scope="conv_0", name=name)
      ...
      layer = conv2d(layer, 32, 5, 1, padding='VALID', normalizer_fn=None, scope="conv_0_0", name=name)
  ...
  def _build_learner(self, layer, name, reuse=False):
    with tf.variable_scope("learner", reuse=reuse) as sc:
      ...
      layer = conv2d(layer, 16, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_0_0", name=name)
      layer = conv2d(layer, 16, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_0_1", name=name)
      layer = conv2d(layer, 16, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_0_2", name=name)
      layr1 = layer;

      layer = slim.max_pool2d(layer, 2, 2, scope="pool_1")
      layer = conv2d(layer, 32, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_1_0", name=name)
      layer = conv2d(layer, 32, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_1_1", name=name)
      layer = conv2d(layer, 32, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_1_2", name=name)
      layer = conv2d(layer, 32, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_1_3", name=name)
      layr2 = layer;

      layer = slim.max_pool2d(layer, 2, 2, scope="pool_2")
      layer = conv2d(layer, 64, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_2_0", name=name)
      layer = conv2d(layer, 64, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_2_1", name=name)
      layer = conv2d(layer, 64, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_2_2", name=name)
      layer = conv2d(layer, 64, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_2_3", name=name)
      layr3 = layer;

      layer = slim.max_pool2d(layer, 2, 2, scope="pool_3")
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_3_0", name=name)
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_3_1", name=name)
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_3_2", name=name)
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_3_3", name=name)
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_3_4", name=name)
      layr4 = layer;
      ...
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_5_0", name=name)
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_5_1", name=name)
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_5_2", name=name)
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_5_3", name=name)
      layer = conv2d(layer, 128, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_5_4", name=name)
      layer = slim.conv2d_transpose(layer, 128, 2, 2, padding='VALID', activation_fn=lrelu, normalizer_fn=None, scope="deconv_1");
      layer = tf.concat([layer, layr3], 3)

      layer = conv2d(layer, 64, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_6_0", name=name)
      layer = conv2d(layer, 64, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_6_1", name=name)
      layer = conv2d(layer, 64, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_6_2", name=name)
      layer = conv2d(layer, 64, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_6_3", name=name)
      layer = slim.conv2d_transpose(layer, 64, 2, 2, padding='VALID', activation_fn=lrelu, normalizer_fn=None, scope="deconv_2");
      layer = tf.concat([layer, layr2], 3)

      layer = conv2d(layer, 32, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_7_0", name=name)
      layer = conv2d(layer, 32, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_7_1", name=name)
      layer = conv2d(layer, 32, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_7_2", name=name)
      layer = conv2d(layer, 32, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_7_3", name=name)
      layer = slim.conv2d_transpose(layer, 32, 2, 2, padding='VALID', activation_fn=lrelu, normalizer_fn=None, scope="deconv_3");
      layer = tf.concat([layer, layr1], 3)

      layer = conv2d(layer, 16, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_8_0", name=name)
      layer = conv2d(layer, 16, 3, 1, padding='SAME', normalizer_fn=None, scope="conv_8_1", name=name)
