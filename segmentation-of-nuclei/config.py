...
train_arg.add_argument('--reg_scale_l1', type=float, default=0.001, help='')
train_arg.add_argument('--reg_scale_l2', type=float, default=0.01, help='')
...
misc_arg.add_argument('--trained_model_dir', type=str, default='cnn_model')
