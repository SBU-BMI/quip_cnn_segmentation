...
train_arg.add_argument('--reg_scale_l1', type=float, default=0.02, help='')
train_arg.add_argument('--reg_scale_l2', type=float, default=0.2, help='')
train_arg.add_argument('--real_scale', type=float, default=0.5, help='')
train_arg.add_argument('--learner_adv_scale', type=float, default=0.00000001, help='')
...
train_arg.add_argument('--initial_K_l', type=int, default=5000, help='')
...
train_arg.add_argument('--sup_batch_size', type=int, default=24, help='')
...
train_arg.add_argument('--importance_minimum', type=float, default=0.5, help='')
